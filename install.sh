...
select de in yes no; do
	case $de in
		...
		sudo pacman -Syuu
		sudo pacman -S base-devel xorg-server xorg-xinit xorg-xrdb xf86-video-intel i3-gaps rofi ranger alsa-utils pulseaudio feh python-pywal xorg-xbacklight dunst libnotify scrot ueberzug xorg-xinput pcmanfm neovim xsel lxappearance otf-ipafont noto-fonts-emoji python-pip xclip mpv youtube-dl zathura zathura-pdf-mupdf transmission-cli picom alacritty rxvt-unicode sxiv tlp tp_smapi acpi_call
		...
		yay -S polybar ttf-roboto sc-im brave terminus-font
